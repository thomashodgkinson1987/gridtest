...
-   **Task Completion:** I will manage tasks in `/.blueprint/KANBAN_CURRENT.md`, `/.blueprint/KANBAN_BACKLOG.md`, and `/.blueprint/KANBAN_COMPLETED.md` by moving them through the Kanban sections: from `KANBAN_BACKLOG.md` to `KANBAN_CURRENT.md`, and finally to `KANBAN_COMPLETED.md`.
