...
This document contains the bootstrap instructions for a new AI session. Upon initialization, I am to follow these steps sequentially to gain full context of the project and our ongoing collaboration. You will now be asked to read several context-supporting documents that are stored in the project repository.
...
3.  **Review Kanban Boards:** Read the contents of the three Kanban board files, located in the `/.blueprint/` directory, to understand the project's state:
    -   `/.blueprint/KANBAN_CURRENT.md`: The single task that is currently in progress.
    -   `/.blueprint/KANBAN_BACKLOG.md`: The list of tasks waiting to be worked on.
    -   `/.blueprint/KANBAN_COMPLETED.md`: The history of all completed tasks.
