...
2.  **Understand the Project:** Read the contents of `/.tabernacle/PROJECT-OVERVIEW.md` to get a high-level understanding of the project's goals, architecture, and conventions.

3.  **Review Kanban Boards:** Read the contents of the three Kanban board files, located in the `/.cubit/` directory, to understand the project's state:
...
4.  **Review Session Notes:** Read the contents of `/.tabernacle/NOTES.md` to get up to speed on any specific, notes.
